  ...
  return (
    <div className='flex min-h-screen flex-col space-y-4 p-4'>
      ...
      <Card
        ...
        style={{
          height: availableHeight > 0 ? `${availableHeight * 0.5}px` : '50vh', // dynamically set ~100% of available space
        }}
      >
        <CardHeader>
          <CardTitle>Selected Products</CardTitle>
          <CardDescription>
            Add up to 4 products to compare across brands
          </CardDescription>
        </CardHeader>
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-8'>
        <Card className='col-span-1 lg:col-span-2'>
          <CardHeader>
            ...
            <CardDescription>
              Sentiment Analysis across the selected products
            </CardDescription>
          </CardHeader>
        ...
        <Card className='col-span-1 lg:col-span-2'>
          <CardHeader>
            ...
            <CardDescription>
              Ratings across the selected products
            </CardDescription>
          </CardHeader>
          <CardContent className='px-6'>
            <AnalyticsChart />
        ...
        <Card className='col-span-1 lg:col-span-2'>
          <CardHeader>
            ...
            <CardDescription>
              Market variations across the selected products
            </CardDescription>
          </CardHeader>
          <CardContent className='px-6'>
            <AnalyticsChart />
